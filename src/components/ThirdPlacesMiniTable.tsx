...
export function ThirdPlacesMiniTable({ onOpenFull }: ThirdPlacesMiniTableProps) {
  const { thirdPlaceCandidates } = useApp()
        ...
        <table className="w-full min-w-[360px] text-left text-[10px]">
          <thead>
            <tr className="border-b border-white/10 text-white/40">
              ...
              <th className="px-2 py-2 text-center font-semibold">G-E-P</th>
            </tr>
          </thead>
          <tbody>
            {thirdPlaceCandidates.map((c) => (
              ...
              >
                ...
                <td className="px-2 py-1.5 text-center tabular-nums text-white/50">
